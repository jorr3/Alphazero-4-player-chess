...
namespace fpchess
{
    ...
    public:
        ...
        void SetRootState(std::shared_ptr<Board> state) {
            rootState = state;
        }
        ...
        std::unordered_map<chess::PlayerColor, std::vector<chess::BoardLocation>> GetAttackedSquaresPlayers() const;
        std::unordered_map<chess::Team, std::vector<chess::BoardLocation>> GetAttackedSquaresTeams() const;
        ...
        std::shared_ptr<Node> ChooseLeaf();
        ...
        static torch::Tensor GetEncodedState(const Board state, const std::string &device);
    ...
    private:
        ...
        static std::map<chess::PlayerColor, int> GenerateColorChannelOffsets(chess::PlayerColor color);
    };
    ...
    struct MemoryEntry
    {
        ...
        MemoryEntry(const Board &s, const at::Tensor &a)
            : state(s), action(a) {}
    };
